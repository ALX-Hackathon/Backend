...
const FeedbackSchema = new mongoose.Schema({
    ...
    feedbackType: { type: String, enum: ['compliment', 'complaint', 'suggestion', 'general'] },
    ...
    category: { type: String, enum: ['Room', 'Food', 'Service', 'Maintenance', 'Other'] }, // Only for source=Staff
